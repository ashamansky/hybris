 ...
 */
package de.hybris.platform.bonstorefrontend.jalo;
...
/**
 * This is the extension manager of the Bonstorefrontend extension.
 */
public class BonstorefrontendManager extends GeneratedBonstorefrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(BonstorefrontendManager.class);
	 ...
	 */
	public static BonstorefrontendManager getInstance()
	{
		return (BonstorefrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BonstorefrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonstorefrontendManager() // NOPMD 
	{
		LOG.debug("constructor of BonstorefrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of BonstorefrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of BonstorefrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
