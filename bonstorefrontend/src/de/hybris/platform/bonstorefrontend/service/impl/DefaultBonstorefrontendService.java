...
public class DefaultBonstorefrontendService implements BonstorefrontendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBonstorefrontendService.class);
	...
	{
		return DefaultBonstorefrontendService.class.getResourceAsStream("/bonstorefrontend/sap-hybris-platform.png");
	}
