...
public class BonstorehmcManager extends GeneratedBonstorehmcManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(BonstorehmcManager.class);
	...
	{
		return (BonstorehmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BonstorehmcConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of BonstorehmcManager called, current tenant: {}", getTenant().getTenantID());
	}
