 ...
 */
package de.hybris.platform.bonstorehmc.service.impl;
...
public class DefaultBonstorehmcService implements BonstorehmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBonstorehmcService.class);
	...
	{
		return DefaultBonstorehmcService.class.getResourceAsStream("/bonstorehmc/sap-hybris-platform.png");
	}
