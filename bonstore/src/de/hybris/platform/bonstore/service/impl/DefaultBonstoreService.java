...
public class DefaultBonstoreService implements BonstoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultBonstoreService.class);
	...
	{
		return DefaultBonstoreService.class.getResourceAsStream("/bonstore/sap-hybris-platform.png");
	}
