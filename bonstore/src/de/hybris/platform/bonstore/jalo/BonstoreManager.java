...
/**
 * This is the extension manager of the Bonstore extension.
 */
public class BonstoreManager extends GeneratedBonstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(BonstoreManager.class);
	 ...
	 */
	public static BonstoreManager getInstance()
	{
		return (BonstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(BonstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public BonstoreManager() // NOPMD 
	{
		LOG.debug("constructor of BonstoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of BonstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of BonstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
