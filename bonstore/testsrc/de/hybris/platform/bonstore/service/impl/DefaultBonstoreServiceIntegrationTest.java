...
import de.hybris.platform.bonstore.service.impl.DefaultBonstoreService;
 ...
 */
@IntegrationTest
public class DefaultBonstoreServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "bonstorePlatformLogo";

		// when
		final String logoUrl = bonstoreService.getHybrisLogoUrl(logoCode);
